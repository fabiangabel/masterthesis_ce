...
%       \fill[gray!50,opacity=0.7] (B26) -- (B42) -- (B43) -- (B27) -- cycle;  %right
        ...
        \draw[gray,dashed] (B8) -- (B16) -- (B48);
        \draw[gray,dashed] (B16) -- (B14);
        \draw[gray,dashed] (B32) -- (B30);
        \draw[gray,dashed] (B12) -- (B10);
        \draw[gray,dashed] (B32) -- (B30);
        \draw[gray,dashed] (B7) -- (B15) -- (B47);
        \draw[gray,dashed] (B23) -- (B31);
        \draw[gray,dashed] (B12) -- (B44);
        \draw[gray,dashed] (B26) -- (B28);
        \draw[gray,dashed] (B24) -- (B32);
        \draw[gray,dashed] (B11) -- (B43);
