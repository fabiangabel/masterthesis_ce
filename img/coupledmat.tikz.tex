...
\begin{tikzpicture}
    ...
    %CPLD MATRIX%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \foreach \j in {0,...,5} {
        \draw [very thin,black] (0,\j*\xStep) -- (\xStep*\nStep,\j*\xStep)  ;
        \draw [very thin,black] (\j*\xStep,0) -- (\j*\xStep,\xStep*\nStep)  ;
    }
   ...
   %LEGEND
   %\node[draw,align=left,fill=red] at (-\offset,7) {Pressure-velocity coupling      };
   %\node[draw,align=left,fill=cyan]at (-\offset,6) {Velocity-to-temperature coupling} ;
   %\node[draw,align=left,fill=green] at (-\offset,5) {Temperature-to-velocity and \\temperature-to-pressure coupling};
