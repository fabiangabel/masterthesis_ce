...
\ra{1.3}
  \begin{tabular}{cccc}\toprule
    ...
    \rowcolor{black!20} \multirow{-3}{*}{128x128x128}& 1.14047118284635437E-004 & & 2.0214  \\ %\hline
    %
    \rowcolor{black!00}\multirow{3}{*}{}             &  & &   \\
    \rowcolor{black!00}                              &  & &   \\
    \rowcolor{black!00} \multirow{-3}{*}{256x256x256}&  & &   \\ %\hline
...
\ra{1.3}
  \begin{tabular}{cccc}\toprule
    ...
    \rowcolor{black!20} 128x128x128 & 5.16070564885203701E-003 &                           & 1.4792 \\%\hline
    \rowcolor{black!00} 256x256x256 &                          &                           &        \\%\hline
...
\ra{1.3}
  \begin{tabular}{cccc}\toprule
    ...
    \rowcolor{black!20} 128x128x128 & 2.9310098015820527E-004   &                          & 1.9951 \\%\hline
    \rowcolor{black!00} 256x256x256 &                           &                          &        \\%\hline
    %\rowcolor{black!00} 64x64x64 &   &   &    \\%\hline
  \end{tabular}
...
%   \addplot[color=black,mark=*] coordinates {
%       (0.1,5.6980532519690480E-004) 
%       (0.2,5.7282825021960508E-004) 
%       (0.3,5.7521955081879139E-004) 
%       (0.4,5.7727921879969275E-004) 
%       (0.5,5.7913055903698858E-004) 
%       (0.6,5.8083681827555198E-004) 
%       (0.7,5.8243530147906699E-004) 
%       (0.8,5.8395041040354771E-004) 
%       (0.9,5.8539768371656300E-004) };
%       \addlegendentry{Standard Rhie-Chow}
%   \addplot[color=black,mark=square*] coordinates {
%       (0.1,5.8678820615909990E-004) 
%       (0.2,5.8678874094430276E-004) 
%       (0.3,5.8678885567958217E-004) 
%       (0.4,5.8678886401015040E-004) 
%       (0.5,5.8678887243265083E-004) 
%       (0.6,5.8678889586393626E-004) 
%       (0.7,5.8678908675540127E-004) 
%       (0.8,5.8678937542763532E-004) 
%       (0.9,5.8678937453692470E-004) };
%       \addlegendentry{Pressure Weighted Interpolation Method}
\end{semilogyaxis}
\end{tikzpicture}
