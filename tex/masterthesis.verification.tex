...
\end{displaymath}
The following tables will list the calculated error terms for the velocities, the pressure and the temperature for different grid resolutions and both solver algorithms. The grid resolutions \((n \times n \times n)\) are chosen such that \(n\), the number of control volumes in each coordinate direction, will be a power of \(2\). The Errors were evaluated after the maximal relative residual of all linear systems in one outer iteration fell below the threshold \(1\e{-14}\). The concrete implementation of the tolerance criterion to accept a converged solution is found in section \ref{sec:convergence}.
...
\ra{1.3}
  ...
  \begin{tabular}{cccc}\toprule
    ...
    %
    \rowcolor{black!20}\multirow{3}{*}{}             & 1.172266972290949E-004 & & 2.0177  \\
    \rowcolor{black!20}                              & 1.150024026498247E-004 & & 2.0091  \\
    \rowcolor{black!20} \multirow{-3}{*}{128x128x128}& 1.140471182846354E-004 & & 2.0214  \\ %\hline
    %
...
\ra{1.3}
  ...
  \begin{tabular}{cccc}\toprule
    ...
    \midrule
    \rowcolor{black!20} 8x8x8       & 0.183035893121686      &  0.1830358946646808      &        \\%\hline
    \rowcolor{black!00} 16x16x16    & 8.967727683983406E-002 &  8.9677276839825765E-002 & 1.0293 \\%\hline
    \rowcolor{black!20} 32x32x32    & 3.796485688816108E-002 &  3.7964815814009345E-002 & 1.2401 \\%\hline
    \rowcolor{black!00} 64x64x64    & 1.438780100622541E-002 &  1.4387801006156546E-002 & 1.3998 \\%\hline
    \rowcolor{black!20} 128x128x128 & 5.160705648852031E-003 &                          & 1.4792 \\%\hline
    \rowcolor{black!00} 256x256x256 & 1.809811107444374E-003 &                          & 1.5117 \\%\hline
  \end{tabular}
...
\ra{1.3}
  ...
  \begin{tabular}{cccc}\toprule
    ...
    \midrule
    \rowcolor{black!20} 8x8x8       & 4.067532377541200E-003  & 4.0675323775378296E-003  &        \\%\hline
    \rowcolor{black!00} 16x16x16    & 1.132477318394773E-003  & 1.1324773183947821E-003  & 1.8447 \\%\hline
    \rowcolor{black!20} 32x32x32    & 2.931009801582052E-004  & 2.9310096243402903E-004  & 1.9500 \\%\hline
    \rowcolor{black!00} 64x64x64    & 7.410021974469997E-005  & 7.4100219743344219E-005  & 1.9838 \\%\hline
    \rowcolor{black!20} 128x128x128 & 1.858846421984987E-005  &                          & 1.9951 \\%\hline
    \rowcolor{black!00} 256x256x256 & 4.651911366447223E-006  &                          & 1.9985 \\%\hline
  \end{tabular}
  \label{tab:temporder}
\end{table}
...
\end{semilogyaxis}
\end{tikzpicture}
\caption{Comparison of calculated error for different under-relaxation factors $\alpha_\vec{u}$ on a grid with different grid resolutions unknowns}
\label{fig:underrelaxation}
\end{figure}
