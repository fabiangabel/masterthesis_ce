...
\end{displaymath}
Since the velocity field was created as an solenoidal field no pressure sorce had to be calculated. The manufactured solution for the temperature \(T\) reads
\begin{align*}
