...
Using the data from table \ref{tab:channel} and the maximal inflow velocity the Reynolds number \(Re\) can be calculated as
\begin{displaymath}
  Re = \frac{\rho max(u_1) l}{\mu} = 45,
\end{displaymath}
which shows that the flow resides in a laminar regime.
