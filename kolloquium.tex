...
\begin{frame}\scriptsize
  ...
  \end{itemize}
  \begin{itemize}
    \item Newton-Raphson Linearisierung des konvektiven Terms der Temperaturgleichung \\(Galpin et al.)
  \end{itemize}
\begin{align*}
...
\begin{frame}\scriptsize
  ...
  \begin{align*}
    ...
    T(\vec{x}) &= \sin \left( {x_1}^{2} \right) \cos \left( {x_2}^{2} \right) \sin \left( {x_3 }^{2} \right).
  \end{align*}
  \begin{itemize}
...
\begin{frame}\scriptsize
  ...
  \begin{itemize}
    ...
    \item 3d lockstrukturierte Gitter mit hängenden Knoten
  ...
  \end{itemize}
  \vspace{1cm}
  weiterer Forschungbedarf:
  \begin{itemize}
    \item instationäre laminare Strömungen bei hohen Rayleighzahlen
    \item implizite Kopplung im Kontext von Turbulenz, Mehrphasenströmungen, etc.
