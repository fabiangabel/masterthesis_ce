...
\begin{document}
\thesistitle{Implementation and performance analyses of a highly efficient algorithm for pressure-velocity coupling}{Implementierung und Untersuchung einer hoch effizienten Methode zur Druck-Geschwindigkeit-Kopplung}
